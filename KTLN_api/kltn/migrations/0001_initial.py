# Generated by Django 4.2.11 on 2024-04-02 17:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hoidong', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kltn.hoidong')),
                ('nganh', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kltn.nganh')),
                ('giangvien', models.ManyToManyField(to='kltn.giangvien')),
